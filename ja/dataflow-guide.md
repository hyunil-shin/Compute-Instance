...
* フローテンプレートを指定して、ユーザーが必要な機能のフローを簡単に読み込むことができます。
...
* フローがスケジューラにより実行中であっても、ユーザーにより開始したフローと同様にフローを開始することはできません。
...
* タイムアウト時間が残っている状態でドレイニングが完了した場合、即座に終了します。
* ドレイニング中のフローはフロー終了により即座に終了できます。